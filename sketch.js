...
function preload()
{
  ...
  bg_img = loadImage('b1.jpg');
  food = loadImage('melancia.png');
  rabbit = loadImage('magali-normal.png');

  blink = loadAnimation("magali-normal.png","magali-normal.png","magali-normal.png");
  eat = loadAnimation("Magali-comendo.png", "Magali-comendo.png");
  sad = loadAnimation("magali-normal.png","magali-normal.png");
...
function setup() {
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(270,90,100,100);
